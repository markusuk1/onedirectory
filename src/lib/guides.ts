...
export const GUIDES: Guide[] = [
  {
    ...
    keywords: [
      ...
      "pink party bus newcastle",
      "party bus newcastle prices",
      "newcastle party bus hire prices",
      "party bus hire north east",
      "party bus sunderland",
      "party bus durham",
      "party bus middlesbrough",
    ],
  },
  {
    ...
    keywords: [
      ...
      "self drive minibus hire middlesbrough",
      "self drive minibus hire sunderland",
      "self drive minibus hire durham",
      "self drive minibus hire darlington",
      "self drive minibus hire hartlepool",
      "self drive minibus hire northumberland",
      "self drive minibus hire teesside",
      "self drive minibus hire stockton on tees",
    ],
  },
  {
    ...
    keywords: [
      ...
      "16 seater minibus hire newcastle upon tyne",
      "16 seater minibus durham",
      "16 seater minibus hire north east",
      "16 seater minibus newcastle upon tyne",
    ],
  },
  {
    ...
    keywords: [
      "airport transfer durham",
      "airport transfer middlesbrough",
      "airport taxi middlesbrough",
      "durham airport shuttle",
      "durham airport transfer",
      "minibus hire newcastle airport",
      "airport transfer north east",
      "airport transfer sunderland",
      "coach hire newcastle airport",
    ],
  },
  {
    ...
    keywords: [
      ...
      "wedding bus hire middlesbrough",
      "vintage bus hire durham",
    ],
  },
];
